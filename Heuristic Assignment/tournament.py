...
from game_agent import aggressive_heuristic, defensive_heuristic, maximizing_win_chances_heuristic, minimizing_losing_chances_heuristic, chances_heuristic, weighted_chances_heuristic, weighted_chances_heuristic_2, custom_heuristic
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                   ...
                   Agent(CustomPlayer(score_fn=custom_heuristic, **CUSTOM_ARGS), "GROUP_1")]
